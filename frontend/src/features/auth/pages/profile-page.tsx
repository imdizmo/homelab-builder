...
import {
    LogOut, User, Mail, FolderOpen, ChevronLeft, Shield
} from 'lucide-react'
import {
    Dialog,
    DialogContent,
...
export default function ProfilePage() {
    ...
    return (
        <div className="flex flex-col min-h-screen bg-background p-6">
            ...
            <button
                onClick={() => navigate(-1)}
                className="flex items-center gap-1.5 text-sm text-muted-foreground hover:text-foreground transition-colors mb-8 w-fit"
            >
                ...
                <Card className="overflow-hidden">
                    ...
                    <CardContent className="pt-0 pb-6 relative">
                        <div className="flex items-end gap-4 -mt-12">
                            <div className="rounded-full border-4 border-background shadow-lg overflow-hidden h-20 w-20 shrink-0 bg-muted">
                                <img
                                    src={avatarUrl}
                                    alt={user?.name}
