...
const PRESETS: {
    category: string
    items: { label: string; type: HardwareType; icon: React.ElementType; sub: string; data: object }[]
}[] = [
    {
...
export function HardwareToolbox() {
    ...
    const onDragStart = (event: React.DragEvent, nodeType: HardwareType, data?: object) => {
        ...
        if (data) {
            event.dataTransfer.setData('application/reactflow-data', JSON.stringify({ type: nodeType, ...data }))
        }
        ...
        >
            ...
            >
                <div className="flex items-center gap-2">
                    <span className="font-bold text-xs uppercase tracking-wider text-muted-foreground">Library</span>
                </div>
                <button
                    ...
                    <div className="overflow-y-auto flex-1 p-3">
                        ...
                        {activeTab === 'components' && (
                            <div className="space-y-2">
                                <p className="text-[10px] text-muted-foreground mb-2">Drag any component onto the canvas</p>
                                                        ...
                                                        return (
                                                            ...
                                                            >
                                                                ...
                                                                <div className="min-w-0">
                                                                    ...
                                                                    <p className="text-[9px] text-muted-foreground truncate">{preset.sub}</p>
                                                                </div>
                                                            </div>
                                                        )
                                                    })}
